...
/**
 * <p>
 * Read and write camera settings. Use to set or get multiple parameters at
 * once.
 * </p>
 * <p>
 * First call {@link #readConfig()}, then call
 * {@link #getParameter(java.lang.String)} and
 * {@link #setParameter(java.lang.String, java.lang.String)} as many times as
 * needed. Finish by calling {@link #writeConfig()} to write updated parameters
 * to the camera.
 * </p>
 * <p>
 * This method is more efficient than using
 * {@link com.angryelectron.gphoto2.GPhoto2#setConfig(java.lang.String, java.lang.String)}
 * and {@link com.angryelectron.gphoto2.GPhoto2#getConfig(java.lang.String)}
 * since the configuration is stored in memory, instead of on the camera.
 * </p>
 * 
 */
public class GPhoto2Config {
	...
	/**
	 * Verify return codes. If the return code is not GP_OK, an IO Exception is
	 * thrown. Used to verify every libgphoto2 call.
	 * 
	...
	/**
	 * Retrieve a parameter's value. The value type depends on the parameter type.
	 * This method retrieves the value using the correct type, then converts it to a
	 * string.
	 * 
...
//===============================================================================	
	...
	/**
	 * Read the camera's current configuration. This must be called before getting
	...
	public void readConfig() throws IOException {
		...
		do {
			rc = gphoto2.gp_camera_get_config(camera, camWidg, context);
	 ...
	 * setParameter() calls to save the new settings to the camera. It can be called
	 * once after setting multiple parameters.
	 * 
	...
	public void writeConfig() throws IOException {
		...
		do {
			rc = gphoto2.gp_camera_set_config(camera, cameraWidget, context);
		} while (Gphoto2Library.GP_ERROR_CAMERA_BUSY == rc);
...
//===============================================================================
	 ...
	 * numbered, with the value appearing last (ie. when setting "evstep", use "1/3"
	 * for "Choice: 0 1/3", not "0"). Strings are case sensitive.
	 * 
	 * @param param The parameter to set. If getting parameters via --list-config,
	 *              do not specify the entire path (ie. use 'iso', not
	...
	/**
	 * Get the value of a parameter. A list of parameters can be viewed by running
	 * 'gphoto2 --list-config'.
	 * 
